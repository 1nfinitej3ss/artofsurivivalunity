...
public class Home2Controller : MonoBehaviour
{
    ...
    private void Start()
    {
        Debug.Log("Home2Controller Start");
    ...
    private IEnumerator InitializeWithDelay()
    {
        ...
        Debug.Log("[Home2] Checking QuestionContentManager state");
        if (QuestionContentManager.Instance == null)
        {
            Debug.LogError("[Home2] QuestionContentManager.Instance is null! Loading default questions...");
        ...
        Debug.Log("[Home2] Checking if questions are loaded");
        if (!QuestionContentManager.Instance.HasLoadedQuestions())
        {
            Debug.LogError("[Home2] No questions loaded! Please load questions in the start scene first.");
            SceneManager.LoadScene("StartScene");
            yield break;
        }
        
        Debug.Log("[Home2] Getting random question from QuestionContentManager");
        QuestionData question = QuestionContentManager.Instance.GetRandomQuestionForScene("home");
        if (question != null)
        {
